...
function print_child_support_letter() {
    ...
    writeAuditlog($_SESSION['userName'], $_SESSION['curr-id'], "Child Support Grant", 'Printing client letter for required child support docs.');

    // Send an SMS to the client too.
    $message = '*DEMO* Application for Child Support Started. Please obtain the required documentation and present to the SASSA. *DEMO*';
    $to = $_SESSION['cellNo'];
    sendSms($message, $to);
